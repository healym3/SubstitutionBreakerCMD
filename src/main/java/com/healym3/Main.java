...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        breakerResult = breaker.breakCipher("msr crkqimurem xz jxukdmri bjvrejr qec renverriven mrjsextxna vb xer " +
...
//                "kixhrjm qttxpb bmdcremb mx qkkta msrvi jxdibr uqmrivqtb qec trqieven " +
        ...
        breakerResult = breaker.breakCipher("Zn nabomrct wbtn, Tbewvc Ovmorvkvon cvvw ebmn bu vivoxrnv. " +
